...
export default function DetailSection({ keyOfMovie, detail }: Props) {
    console.log(keyOfMovie);
    return (
        <div className=" lg:h-[50%] h-screen relative">
            <img
                ...
                <div className="flex justify-evenly  flex-col lg:flex-row items-center h-full ">
                    ...
                    <div className="w-[50%] flex flex-col lg:gap-6 gap-5">
                        ...
                        <h2 className="lg:text-2xl text-xl text-amber-500">
                            IMDB Voting {detail.vote_average}
                        </h2>
                        <div className="">
                        ...
                        <div className="">
                            <h4 className="text-3xl">The Casts</h4>
                            <div className="">{detail.original_language}</div>
                        </div>
                        <div className="flex gap-5">
                            <Link
                                ...
                                target="_blank"
                            >
                                <button className="px-10 py-2 border-2 border-neutral-200 hover:scale-105 bg-amber-500 hover:text-black rounded-md duration-300 delay-200 ">
                                    Trailer
                                </button>
                            </Link>
                            <Link
