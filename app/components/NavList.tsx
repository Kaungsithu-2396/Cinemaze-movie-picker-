    ...
    return (
        <li>
            <Link href={to}>
                ...
                <h1 className="hover:text-amber-400 p-5 text-base  lg:border-0 rounded-lg   duration-200 delay-200 hover:scale-105 hover:bg-black   w-full text-white/60 lg:rounded-md">
                    {title}
                </h1>
            </Link>
        </li>
